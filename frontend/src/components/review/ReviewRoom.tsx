    ...
    return (
      <div className="dot-grid font-dm min-h-screen text-white flex flex-col items-center justify-center px-4">
        <style>{`
          ...
          .dot-grid { background-color: var(--bg-dot); background-image: radial-gradient(var(--dot-color) 1px, transparent 1px); background-size: 28px 28px; }
        `}</style>
    ...
    <>
      ...
      <div className="dot-grid font-dm h-screen overflow-hidden text-white flex flex-col">
        ...
        <div className="flex-1 overflow-hidden flex flex-col lg:flex-row">
          ...
          {/* ── Code panel ── */}
          <div className={`theme-code-surface ${mobileTab === "code" ? "flex" : "hidden"} lg:flex
